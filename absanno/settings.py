"""
Django settings for absanno project.
...
ALLOWED_HOSTS = ['127.0.0.1', 'localhost', 'absanno-abstract.app.secoder.net']
...
MIDDLEWARE = [
    ...
    'django.middleware.csrf.CsrfViewMiddleware',  # only for online test
]

ROOT_URLCONF = 'absanno.urls'
